...
/**
 * SmacDirectoryUtils is a class which groups static methods pertaining to folder operations used throughout the SMAC
 * daemon.
 *
 * @author Bishan Kumar Madhoo <bishan.madhoo@idsoft.mu>
 * @version 1.0
 */
public class SmacDirectoryUtils {
    ...
    public static String getCurrentWorkingDirectory() {
        ...
        URL location = Smac.class.getProtectionDomain().getCodeSource().getLocation();
