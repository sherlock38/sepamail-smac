...
/**
 * The ConfigurationFileNotFoundException class is the exception raised when the configuration required for the SMAC
...
public class ConfigurationFileNotFoundException extends FileNotFoundException {
    ...
    public ConfigurationFileNotFoundException() {
        ...
        super("The SMAC configuration file could not be found.");
    }

    /**
     * ConfigurationFileNotFoundException constructor
     *
     * @param filename SMAC configuration filename
     */
    public ConfigurationFileNotFoundException(String filename) {

        // Initialise the parent class
        super("The SMAC configuration file " + filename + " could not be found.");
    }
}
